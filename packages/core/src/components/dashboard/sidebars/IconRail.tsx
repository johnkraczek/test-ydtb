...
import { CustomizeNavigationDialog, ToolItem } from "@ydtb/core/components/dashboard/customization/CustomizeNavigationDialog";
          ...
          {visibleTools.map((tool) => {
            ...
            return (
              <Tooltip key={tool.id}>
                <TooltipTrigger asChild>
                  <Button
                    className={`h-9 w-9 p-0 rounded-sm transition-all duration-300 ${isActive
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <PopoverTrigger asChild>
                  <Button
                    className={`h-9 w-9 p-0 rounded-sm transition-all duration-300 ${isMoreOpen
