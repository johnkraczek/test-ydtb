              ...
              <Card key={step.id} className="border-slate-200 dark:border-slate-800 shadow-sm relative group">
                ...
                <CardContent className="pl-12 pr-6 py-6 space-y-4">
                  ...
                  <div className="space-y-4">
                        ...
                        <div className="relative group w-fit">
                          <div className="rounded-lg overflow-hidden border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950">
                            <img
                              src={step.image.url}
                              alt="Step visual"
                              className={`w-auto object-cover ${step.image.size === 'small' ? 'h-32' :
                          ...
                          <div className="space-y-1.5">
                            ...
                            <div className="flex gap-2 items-center">
                              <Tabs
                                ...
                                className="w-full"
                              >
                                <TabsList className="flex w-fit h-8 p-1 bg-black/5 dark:bg-black/20 gap-1">
                    ...
                    {step.note && (
                      <div
                        className={`p-4 rounded-md border space-y-3 relative group ${step.note.color === 'blue' ? 'bg-blue-50 border-blue-100 dark:bg-blue-900/10 dark:border-blue-800' :
