                    ...
                    <div className="flex gap-2 mt-3 pt-2">
                      {[
                        ...
                        <button
                          ...
                          className={`h-6 w-6 rounded-full border border-slate-200 transition-transform hover:scale-110 ${color.class} ${themeColor === color.name ? 'ring-2 ring-offset-2 ring-slate-400 scale-110' : ''
                            }`}
                          title={color.name}
                        />
                      ))}
